...
import (
	...
	appConsumer "github.com/shwiftylove-ventures/shwifty/app"
...
// NewCoordinator initializes Coordinator with interchain security dummy provider and shwifty consumer chain
